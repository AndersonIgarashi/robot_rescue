...
export const CHOICE_ICONS: Record<IconId, string> = {
  shield: `<svg viewBox="0 0 64 64" aria-hidden="true"><path d="M32 4l22 8v16c0 15-9 26-22 32C19 54 10 43 10 28V12z" fill="#fff"/><path d="M32 13l13 4.8v10.4c0 9.4-5.4 16.4-13 20.2-7.6-3.8-13-10.8-13-20.2V17.8z" fill="var(--ic-ink)"/><path d="M32 20v22M24 29h16" stroke="#fff" stroke-width="4.5" stroke-linecap="round"/></svg>`,
  ...
  blaster: `<svg viewBox="0 0 64 64" aria-hidden="true"><g transform="rotate(-18 32 32)"><path d="M17 33h13l-3 17h-10z" fill="#fff"/><rect x="8" y="20" width="40" height="15" rx="7.5" fill="#fff"/><rect x="45" y="23" width="12" height="9" rx="3" fill="#fff"/><circle cx="17" cy="27.5" r="3.6" fill="var(--ic-ink)"/><rect x="26" y="25.5" width="13" height="4" rx="2" fill="var(--ic-ink)"/><circle cx="61" cy="27.5" r="3.2" fill="#ffd23f"/></g></svg>`,
  ...
  water: `<svg viewBox="0 0 64 64" aria-hidden="true"><path d="M32 4c9 13 19 23 19 35a19 19 0 0 1-38 0C13 27 23 17 32 4z" fill="#fff"/><path d="M23 40a9 9 0 0 0 9 9" stroke="var(--ic-ink)" stroke-width="4.5" fill="none" stroke-linecap="round"/></svg>`,
  magnet: `<svg viewBox="0 0 64 64" aria-hidden="true"><path d="M10 56V30a22 22 0 0 1 44 0v26H41V30a9 9 0 0 0-18 0v26z" fill="#fff"/><rect x="10" y="45" width="13" height="11" fill="var(--ic-ink)"/><rect x="41" y="45" width="13" height="11" fill="var(--ic-ink)"/></svg>`,
